      ...
      <div className="container-px mx-auto max-w-7xl">
        <div
          className={cn(
            ...
            scrolled || open
              ? "bg-white dark:bg-card border border-border shadow-card"
              : "bg-transparent",
          )}
        >
          ...
          <div className="flex items-center gap-2">
            ...
            {localStorage.getItem("userRole") ? (
              <Link
                to={
                  localStorage.getItem("userRole")?.toLowerCase() === "patient"
                    ? "/patient/dashboard"
                    : localStorage.getItem("userRole")?.toLowerCase() === "doctor"
                      ? "/doctor/dashboard"
                      : "/admin/dashboard"
                }
              >
              ...
              <div className="flex items-center gap-2">
                <Link to="/login">
                  <Button
                    variant="outline"
                    className="rounded-full border border-primary/20 text-foreground hover:bg-muted transition cursor-pointer"
                  >
                    Sign In
                  </Button>
                </Link>
              ...
              {localStorage.getItem("userRole") ? (
                ...
                <div className="flex flex-col gap-2 mt-2">
                  <Link to="/login">
                    <Button
                      variant="outline"
                      className="w-full rounded-xl border border-primary/20 text-foreground"
                    >
                      Sign In
                    </Button>
                  </Link>

      ...
      <div className="container-px mx-auto max-w-7xl py-16 grid gap-10 md:grid-cols-4">
        <div>
          ...
          <p className="mt-4 text-sm text-muted-foreground max-w-xs">
            Modern, compassionate healthcare powered by technology. Trusted by 50,000+ patients
            across the country.
          </p>
          <div className="flex gap-2 mt-5">
            {[Facebook, Instagram, Twitter, Linkedin].map((Icon, i) => (
              <a
                key={i}
                href="#"
                className="grid place-items-center size-9 rounded-lg border hover:bg-muted transition"
                aria-label="Social"
              >
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li className="flex gap-2">
              <Phone className="size-4 mt-0.5 text-primary" /> +91 (80) 4736-0000
            </li>
            <li className="flex gap-2">
              <Mail className="size-4 mt-0.5 text-primary" /> care@medora.health
            </li>
            <li className="flex gap-2">
              <MapPin className="size-4 mt-0.5 text-primary" /> Sector 30A, Vashi,
              <br />
              Navi Mumbai, MH
            </li>
          </ul>

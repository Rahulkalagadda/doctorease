...
const values = [
  {
    ...
    desc: "We treat people, not charts. Every visit starts with listening.",
  },
  {
    icon: ShieldCheck,
    title: "Uncompromising safety",
    desc: "HIPAA-compliant systems and rigorous clinical protocols.",
  },
  {
    icon: Users,
    title: "Built for families",
    desc: "Care for every age, in one connected health record.",
  },
  {
    icon: Award,
    title: "World-class team",
    desc: "Top 1% physicians from Stanford, Hopkins and Mayo.",
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Care that's <span className="text-gradient">human</span>, powered by tech.
          </>
        }
      ...
      <section className="bg-gradient-soft border-y">
        <Section
          ...
          title={
            <>
              Specialists you can <span className="text-gradient">trust</span>
            </>
          }
        >

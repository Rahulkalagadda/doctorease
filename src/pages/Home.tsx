...
const services = [
  {
    icon: HeartPulse,
    title: "Cardiology",
    desc: "Heart screenings, ECG, and chronic care led by board-certified cardiologists.",
    color: "from-rose-500/15 to-rose-500/5",
  },
  {
    icon: Brain,
    title: "Neurology",
    desc: "Migraine, sleep and cognitive consultations with same-week MRI access.",
    color: "from-violet-500/15 to-violet-500/5",
  },
  {
    icon: Baby,
    title: "Pediatrics",
    desc: "Gentle care for newborns to teens, with vaccination & growth tracking.",
    color: "from-amber-500/15 to-amber-500/5",
  },
  {
    icon: Bone,
    title: "Orthopedics",
    desc: "Joint pain, sports injuries and physiotherapy under one roof.",
    color: "from-emerald-500/15 to-emerald-500/5",
  },
  {
    icon: Eye,
    title: "Ophthalmology",
    desc: "Vision tests, LASIK consults and advanced retinal imaging.",
    color: "from-sky-500/15 to-sky-500/5",
  },
  {
    icon: Stethoscope,
    title: "General Medicine",
    desc: "Primary care, preventive screenings and chronic disease management.",
...
const reasons = [
  {
    ...
    desc: "Every physician is verified, licensed and reviewed by peers.",
  },
  {
    icon: Activity,
    title: "Same-Day Appointments",
    desc: "Real-time slot availability — no phone tag, no waiting rooms.",
  },
  {
    icon: Sparkles,
    title: "AI Care Companion",
    desc: "Instant answers about symptoms, prep and follow-ups, 24/7.",
  },
  {
    icon: Award,
    title: "Transparent Pricing",
    desc: "Know the price before you book. Insurance accepted.",
  },
];
...
const testimonials = [
  {
    ...
    quote:
      "Extremely seamless booking. Met Dr. Sharma at the Vashi clinic within 2 hours. The digitized health records on the app are incredibly convenient.",
    rating: 5,
  },
  {
    ...
    role: "Koparkhairane",
    quote:
      "Finding a reliable pediatrician in Navi Mumbai used to be a chore. Medora is a lifesaver — no waiting rooms and extremely polite staff.",
    rating: 5,
  },
  {
    name: "Rohan Joshi",
    role: "Nerul",
    quote:
      "Very premium clinic design and tech integration. The AI assistant helped me understand my symptoms before my orthopedics appointment.",
    rating: 5,
  },
];
...
const faqs = [
  {
    ...
    a: "Yes — we partner with all major Indian providers including Star Health, HDFC Ergo, ICICI Lombard, Niva Bupa and Care Health.",
  },
  {
    q: "Can I do a video consultation?",
    a: "Absolutely. Choose 'Video Consult' during booking and you'll receive a secure video consultation link 10 minutes before.",
  },
  {
    q: "Is the AI assistant a doctor?",
    a: "No. Medora AI helps with bookings, prep and general guidance. All clinical advice comes from our licensed physicians.",
  },
  {
    q: "Where are you located?",
    a: "Our flagship clinic is at Sector 30A, Vashi, Navi Mumbai. We also offer home visits within 10 km.",
  },
];
...
function CustomSelect({ label, value, onChange, options }: CustomSelectProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative rounded-2xl border bg-card p-3 flex flex-col justify-center select-none w-full"
    >
  ...
  return (
    <>
        ...
        <div className="container-px mx-auto max-w-7xl grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="inline-flex items-center gap-2 glass rounded-full px-3 py-1.5 text-xs font-medium"
            >
            ...
            >
              Healthcare that
              <br />
              feels <span className="text-gradient">personal</span> again.
            </motion.h1>
            ...
            >
              Book trusted specialists in minutes, chat with our AI care companion 24/7, and get the
              kind of attentive care your family deserves.
            </motion.p>
            ...
            >
              <Link to="/booking">
                <Button
                  size="lg"
                  className="rounded-full h-12 px-6 bg-gradient-primary text-primary-foreground shadow-glow hover:opacity-95 hover:scale-[1.02] transition-transform animate-pulse-subtle"
                >
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  document
                    .querySelector<HTMLButtonElement>('[aria-label="Open Medora AI"]')
                    ?.click();
                }}
              >
                <Button
                  size="lg"
                  variant="outline"
                  className="rounded-full h-12 px-6 hover:bg-muted hover:scale-[1.02] transition-transform"
                >
            ...
            >
              <div className="flex items-center gap-2">
                <Shield className="size-4 text-primary" /> HIPAA Compliant
              </div>
              <div className="flex items-center gap-2">
                <Star className="size-4 text-amber-500 fill-amber-500" /> 4.9 from 12,400 reviews
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="size-4 text-primary" /> Insurance accepted
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            >
              <div className="size-10 grid place-items-center rounded-xl bg-emerald-500/15 text-emerald-600 shrink-0">
              ...
              <svg
                className="w-16 h-8 text-emerald-500 shrink-0 ml-2"
                viewBox="0 0 100 30"
                fill="none"
            ...
            >
              <div className="size-10 grid place-items-center rounded-xl bg-primary/15 text-primary relative">
                <Calendar className="size-5" />
                <span className="absolute top-0 right-0 size-2.5 rounded-full bg-emerald-500 border-2 border-white dark:border-card animate-ping" />
              </div>
              <div>
                <p className="text-[10px] uppercase font-semibold text-muted-foreground">
                  Next Available Slot
      ...
      <Section className="!py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
          {stats.map((s, i) => (
            ...
            >
              <p className="text-3xl md:text-5xl font-bold text-gradient group-hover:scale-105 transition-transform">
                {s.value}
              </p>
      ...
      <Section
        ...
        title={
          <>
            Specialty care, <span className="text-gradient">all in one place</span>
          </>
        }
      ...
      >
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {services.map((s, i) => (
            ...
            >
              <div
                className={`absolute -top-10 -right-10 size-40 rounded-full bg-gradient-to-br ${s.color} blur-2xl opacity-70`}
              />
      ...
      <section className="bg-gradient-soft border-y">
        <Section
          ...
          title={
            <>
              Built around <span className="text-gradient">your trust</span>
            </>
          }
          description="We've reimagined every step of care — from first click to follow-up."
        >
          <div className="grid lg:grid-cols-3 gap-6 items-stretch">
            ...
            >
              ...
              <div>
                <span className="text-xs uppercase tracking-wider text-primary bg-primary/10 px-3 py-1 rounded-full font-medium">
                  Bespoke Experience
                </span>
                <h3 className="mt-6 text-2xl font-bold tracking-tight">
                  The new gold standard of modern healthcare.
                </h3>
                <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
                  We blend verified medical expertise, luxurious physical clinic design, and instant
                  technology to treat you like family, not a file number.
                </p>
              </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-4 text-3xl md:text-5xl font-bold tracking-tight">
              Answers in seconds.
              <br />
              <span className="text-gradient">Doctors in minutes.</span>
            </h2>
            <p className="mt-4 text-muted-foreground text-lg">
              Medora AI helps you understand symptoms, prepare for visits and find the right
              specialist — all while keeping your data private and secure.
            </p>
            <ul className="mt-6 space-y-3">
              {[
                ...
                "Medication & lab reminders",
              ].map((b) => (
                <li key={b} className="flex gap-2 text-sm">
                  <CheckCircle2 className="size-5 text-primary shrink-0" /> {b}
                </li>
              ))}
            </ul>
            <div className="mt-7">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="space-y-3">
                <div className="max-w-[80%] bg-muted rounded-2xl rounded-bl-md px-4 py-2.5 text-sm">
                  Hi! How can I help today?
                </div>
                <div className="max-w-[80%] ml-auto bg-gradient-primary text-primary-foreground rounded-2xl rounded-br-md px-4 py-2.5 text-sm">
                  I have a mild fever and headache.
                </div>
                <div className="max-w-[85%] bg-muted rounded-2xl rounded-bl-md px-4 py-2.5 text-sm">
                  Got it. I can book you with Dr. Patel in General Medicine today at 3:40 PM. Shall
                  I confirm?
                </div>
              </div>
              <div className="mt-5 flex gap-2 flex-wrap">
                {["Yes, book it", "Other times", "Video consult"].map((c) => (
                  <span key={c} className="text-xs px-3 py-1.5 rounded-full border bg-card">
                    {c}
                  </span>
                ))}
              </div>
      ...
      >
        <div className="grid md:grid-cols-3 gap-5">
          {testimonials.map((t, i) => (
            ...
            >
              <div className="absolute -top-4 -right-2 text-9xl text-primary/5 font-serif select-none pointer-events-none group-hover:text-primary/10 transition-colors">
                "
              </div>
              <div className="relative">
                <div className="flex gap-0.5 mb-4">
                  {Array.from({ length: t.rating }).map((_, k) => (
                    <Star key={k} className="size-4 fill-amber-500 text-amber-500" />
                  ))}
                </div>
          ...
          {faqs.map((f, i) => (
            ...
            >
              <summary className="cursor-pointer flex justify-between items-center font-medium">
                {f.q}
                <span className="ml-4 size-7 grid place-items-center rounded-full bg-primary/10 text-primary group-open:rotate-45 transition">
                  +
                </span>
              </summary>
          ...
          <div className="relative grid md:grid-cols-[1fr_auto] gap-6 items-center">
            <div>
              ...
              <h3 className="mt-2 text-3xl md:text-4xl font-bold">
                When seconds matter, we answer first.
              </h3>
              <p className="mt-3 opacity-90 max-w-2xl">
                Call our triage nurses any time — day or night. We'll guide you and dispatch help if
                needed.
              </p>
            </div>
            <a
              href="tel:+918047360000"
              className="inline-flex items-center gap-3 rounded-2xl bg-white text-primary px-6 h-14 font-semibold shadow-soft hover:scale-[1.02] transition"
            >

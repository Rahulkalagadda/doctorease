      ...
      >
        <div className="glass rounded-3xl p-6 sm:p-8 shadow-glow border bg-card/85 backdrop-blur-md relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <Link
              to="/"
              className="inline-flex items-center gap-2 font-display font-bold text-2xl mx-auto justify-center text-foreground decoration-transparent"
            >
          ...
          {!sent ? (
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                We've sent a link to reset your password to <b>{email}</b>. Please check your spam
                folder if you do not receive it in a few minutes.
              </p>
              <Button

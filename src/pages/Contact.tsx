        ...
        <div className="grid lg:grid-cols-2 gap-10">
              ...
              {[
                {
                  icon: Phone,
                  title: "Call us",
                  value: "+91 (80) 4736-0000",
                  sub: "Mon–Sat, 8 AM – 9 PM",
                },
                {
                  icon: Mail,
                  title: "Email",
                  value: "care@medora.health",
                  sub: "We reply within 1 hour",
                },
                {
                  icon: MapPin,
                  title: "Visit the clinic",
                  value: "Sector 30A, Vashi, Navi Mumbai",
                  sub: "Free patient parking",
                },
                {
                  icon: MessageCircle,
                  title: "WhatsApp",
                  value: "+91 85209 38870",
                  sub: "Quick chat for questions",
                },
                {
                  icon: Clock,
                  title: "Emergency 24/7",
                  value: "+91 (80) 4736-0000",
                  sub: "Always answered live",
                },
              ].map((c) => (
                <div
                  key={c.title}
                  className="p-5 rounded-2xl bg-card border shadow-card flex items-start gap-4"
                >
          ...
          >
            ...
            <div className="mt-6 space-y-4">
              ...
              <Button
                type="submit"
                className="w-full h-12 rounded-xl bg-gradient-primary text-primary-foreground cursor-pointer"
              >
                Send message
              </Button>
            </div>

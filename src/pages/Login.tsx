...
import { Shield, Mail, Lock, ArrowRight, Activity, Chrome, Github, Sparkles, UserCheck } from "lucide-react";
...
export default function Login() {
  ...
  const quickLogin = (role: "patient" | "doctor" | "admin") => {
    setEmail(role === "doctor" ? "doctor@medora.com" : role === "admin" ? "admin@medora.com" : "patient@example.com");
      ...
      >
        <div className="glass rounded-3xl p-6 sm:p-8 shadow-glow border bg-card/85 backdrop-blur-md relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center gap-2 font-display font-bold text-2xl mx-auto justify-center">
          ...
          <div className="relative my-6 text-center">
            ...
            <span className="bg-card px-3 text-xs text-muted-foreground uppercase tracking-wider font-semibold">Or continue with</span>
          </div>
